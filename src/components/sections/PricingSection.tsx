...
export default function PricingSection() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50 relative overflow-hidden" id="pricing-section">
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <div className={`p-6 sm:p-7 lg:p-8 ${
                ...
                <h3 className={`text-xl sm:text-2xl font-bold font-dm-sans mb-3 sm:mb-4 ${
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className={`text-3xl sm:text-4xl font-bold font-dm-sans ${
                    plan.highlighted ? 'text-white' : 'text-gray-900'
                  }`}>
                    {plan.price}
                  </div>
              ...
              <div className="p-6 sm:p-7 lg:p-8">
                  ...
                  {plan.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start gap-2.5 sm:gap-3">
                      <div className={`w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center flex-shrink-0 mt-0.5 ${
                        plan.highlighted ? 'bg-blue-500 text-white rounded-full' : 'text-blue-500'
                      }`}>
                        <FaCheck className="w-2.5 h-2.5 sm:w-3 sm:h-3" />
                      </div>
                      <span className={`text-sm sm:text-base font-inter leading-relaxed ${
                ...
                {/* CTA Button */}
                <button className={`w-full py-3 sm:py-4 rounded-full font-inter font-semibold text-sm sm:text-base transition-all duration-300 ${
                  plan.highlighted
