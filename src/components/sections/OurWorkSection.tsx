...
export default function OurWorkSection() {
  ...
  const projects = [
    ...
    },
    {
      id: 3,
      title: "Find me leads",
      description: "A lead generation bot that monitors subreddits and uses AI to find potential leads based on custom keywords.",
    ...
    },
    {
      ...
      description: "A curated collection of open-source boilerplates and starter kits for building modern scalable applications.",
    ...
    },
    {
      id: 7,
      title: "Re-engage",
      description: "An AI content repurposing tool to transform YouTube videos, articles, & newsletters in LinkedIn and X posts.",
    ...
    },
    {
      id: 8,
      title: "Crunkspot",
      description: "A Web3 marketplace that enables artists to tokenize and sell their music as digital assets on Polygon chain.",
  ...
  return (
    <section id="our-work" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50 relative overflow-hidden">
            ...
            <div key={project.id} className="relative">
              ...
              <div className="text-sm sm:text-base md:text-lg text-gray-600 font-inter leading-relaxed">
                ...
                {project.description.length > 120 && (
                  ...
                  >
                    {expandedDescriptions.has(project.id) ? 'See Less' : 'See More'}
                  </button>
                )}
              </div>
            </div>
