        ...
        <div className="hidden lg:grid grid-cols-2 gap-20 items-center">
          ...
          <div className="relative h-[600px] overflow-hidden">
            ...
            >
              ...
              >
                {/* Triple the testimonials for seamless infinite scroll */}
                {[...testimonials, ...testimonials, ...testimonials].map((testimonial, index) => (
                  <div key={index} className="bg-white rounded-2xl p-10 shadow-sm border border-gray-200 flex-shrink-0">
                    {/* Avatar and Info */}
          ...
          <div className="text-left">
            ...
            <div className="flex items-center mb-8">
              ...
              <div className="min-w-0">
                <h4 className="text-xl font-semibold text-gray-900">Lisa Thompson</h4>
