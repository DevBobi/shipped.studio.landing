  ...
  const testimonials: Testimonial[] = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1600600423621-70c9f4416ae9?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    },
    {
      name: 'Sarah Chen',
    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
          ...
          <div className="relative h-[500px] sm:h-[550px] lg:h-[600px] overflow-hidden order-2 lg:order-1">
            {/* Top Fade Effect */}
            ...
            >
              ...
              >
                ...
                {[...testimonials, ...testimonials, ...testimonials].map((testimonial, index) => (
                  <div key={index} className="bg-white rounded-2xl p-6 sm:p-8 lg:p-10 shadow-sm border border-gray-200 flex-shrink-0">
                    {/* Avatar and Info */}
                    <div className="flex items-center gap-4 sm:gap-6 mb-4 sm:mb-6">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-gray-600 text-sm sm:text-lg">{testimonial.role}</p>
          ...
          <div className="text-center lg:text-left order-1 lg:order-2">
            <h2 className="text-3xl sm:text-4xl md:text-4xl font-medium text-gray-900 mb-6 sm:mb-8 leading-tight px-4 lg:px-0 max-w-sm mx-auto">
              No one tells you the hardest part of starting up
            </h2>
            <div className="flex items-center justify-center lg:justify-start mb-6 sm:mb-8 px-4 lg:px-0">
              ...
              <div className="text-left min-w-0">
                <h4 className="text-lg sm:text-xl font-semibold text-gray-900">Lisa Thompson</h4>
                <p className="text-gray-600 text-sm sm:text-lg">Founder at DataSync Pro</p>
              </div>
            </div>
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed mb-6 sm:mb-8 px-4 lg:px-0">
              &ldquo;I&apos;ve seen too many founders waste $100k+ and months of precious time building their MVP. Let&apos;s get your idea to market in 14 days, so you can focus on what matters - your customers.&rdquo;
            </p>
            <div className="mt-6 sm:mt-8">
              <button className="bg-gray-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-gray-800 transition-colors text-sm sm:text-base">
                Start Your Journey
              </button>
            </div>
          </div>
