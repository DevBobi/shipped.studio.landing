        ...
        <div className="lg:hidden">
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center mb-6 sm:mb-8">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full shadow-lg mr-3 sm:mr-4 flex-shrink-0 overflow-hidden relative">
                <Image
                  ...
                  (testimonial, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 sm:gap-6 mb-4 sm:mb-6">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full shadow-lg flex-shrink-0 overflow-hidden relative">
                          <Image
        ...
        <div className="hidden lg:grid grid-cols-2 gap-20 items-center">
                  ...
                  (testimonial, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-6 mb-6">
                        <div className="w-20 h-20 rounded-full shadow-lg flex-shrink-0 overflow-hidden relative">
                          <Image
                            src={testimonial.image}
                            alt={testimonial.name}
                            fill
          ...
          <div className="text-left">
            ...
            <div className="flex items-center mb-8">
              <div className="w-20 h-20 rounded-full shadow-lg mr-4 flex-shrink-0 overflow-hidden relative">
                <Image
                  src="https://images.unsplash.com/photo-1600600423621-70c9f4416ae9?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Lisa Thompson"
                  fill
